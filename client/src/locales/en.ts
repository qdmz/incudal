export default {
    ...
    admin: {
        ...
        hosts: {
            ...
            pveStorageName: 'Storage Name',
            pveBridgeName: 'Bridge Name',
            pveUsername: 'API Username',
            pvePassword: 'API Password',
            pveRealm: 'Auth Realm',
            pveSshPort: 'SSH Port',
            pveSshPassword: 'SSH Password',
            pveHint: 'PVE nodes are managed via REST API + API Token auth. No Agent needed. Use root@pam!tokenid format for Token auth. SSH password is for NAT port mapping.',
